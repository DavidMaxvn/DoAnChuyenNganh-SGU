...
Route::group(['middleware' => ['checkStatusUser']], function () {
    ...
    Route::post('/recommend', [\App\Http\Controllers\Web\HomeController::class, 'recommend'])->name('recommend');

    Route::post('/ai/recommend', [\App\Http\Controllers\Web\HomeController::class, 'AiRecommend'])->name('ai.recommend');


    Route::get('/search-dish', [\App\Http\Controllers\Web\HomeController::class, 'searchDish'])->name('search.dish');

    Route::get('/get-recipe', [\App\Http\Controllers\Web\HomeController::class, 'getRecipe'])->name('get.recipe');

    Route::get('product/{id}', [\App\Http\Controllers\Web\ProductController::class, 'detail'])
        ->name('detail')
